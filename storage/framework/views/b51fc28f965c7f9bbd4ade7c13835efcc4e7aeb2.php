					...
					<div class="dashboard_ShortListItems">
						<div class="row">
							<div class="col-md-12">
								...
								<!--new added by Hemant (26-08-2023)-->
    							 <div class="dashboard_ShortListItem mt-3">
                	                ...
                	                >
                	                  <div class="ds_item_details">
                	                    <h4 class="total_no"><?php echo e(DB::table('users')->where('role_id', 7)->get()->count()); ?></h4>
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hemant\OfficeProjects\SMS\SMS_Ekattor\resources\views/superadmin/dashboard.blade.php ENDPATH**/ ?>